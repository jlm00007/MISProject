...
namespace BaseballAPI.Repositories
{
    public class PlayerInfo : IPlayerInfo
    {
        ...
        public PlayerInfo(DBContextClass dbContextClass)
        {
        ...
        public async Task<List<Player>> PlayerPos(string Position)
        {
            ...
            var PlayerDetails = await Task.Run(() => _dbContextClass.Player.FromSqlRaw("EXEC spPlayerPos @Position", param).ToListAsync());
